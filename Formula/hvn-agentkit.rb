class HvnAgentkit < Formula
  ...
  url "https://github.com/vietairs/hvn-cli-dist/releases/download/v1.12.1/hak-v1.12.1-dist.tar.gz"
  sha256 "241c2dc51940702483d0201845cc7411747c1964d807368443279725628bfbb0"
  depends_on "node"
